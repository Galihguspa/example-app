...
class WilayahFromJsonSeeder extends Seeder
{
    /**
    ...
    {
        $file_prov = public_path('jsonwilayah/provinsi.json');
        $file_kab = public_path('jsonwilayah/kabupaten.json');
        $file_kec = public_path('jsonwilayah/kecamatan.json');
        $file_kel = public_path('jsonwilayah/kelurahan.json');
